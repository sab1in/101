      ...
      <div className=" w-11/12 lg:w-10/12 xl:w-9/12 mx-auto mb-5 flex overflow-x-auto overflow-y-hidden scrollbar  gap-5 xl:gap-x-14 xl:gap-y-8 mt-8">
        {[1, 2, 3].map((item, index) => {
          return (
            ...
            >
              <div className="pb-2">
                <img src={image1} alt="Frame" width={100} />
              </div>
              ...
              <p className="text-center text-xs font-normal font-roboto text-secondary1">
                We are a group of expertise in designing responsive websites.We
                are a group of expertise in designing responsive websitesWe are
                a group of expertise in designing responsive websites.
              </p>
              <div>
